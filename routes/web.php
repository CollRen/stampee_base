...
Route::get('/enchere/storefavorie', 'EnchereController@storefavorie');
...
Route::get('/enchere/favories', 'EnchereController@index');
Route::get('/enchere/coupcoeurlord', 'EnchereController@index');
