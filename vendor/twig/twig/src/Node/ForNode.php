...
class ForNode extends Node
{
    ...
    public function compile(Compiler $compiler): void
    {
        ...
        $compiler->write('unset($context[\'_seq\'], $context[\'_iterated\'], $context[\''.$this->getNode('key_target')->getAttribute('titre').'\'], $context[\''.$this->getNode('value_target')->getAttribute('titre').'\'], $context[\'_parent\'], $context[\'loop\']);'."\n");
